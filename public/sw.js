const CACHE="elite-performance-beta-v115";
const CORE=["/","/manifest.webmanifest?v=115","/elite-performance-speed-e.svg","/elite-performance-icon-192.png","/elite-performance-icon-512.png","/elite-performance-apple-touch-icon.png"];
