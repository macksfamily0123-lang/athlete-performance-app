...
const checks=[
 ["RC24 version",pkg.version==="72.3.76"],
 ["RC24 beta ribbon",beta.includes("BETA · RC26 · v72.3.76")],
 ...
 ["parent uses support timeline",app.includes("nativeParentTimeline")&&app.includes("nativeTimelineMarker")],
 ["admin uses operations command list",app.includes("nativeAdminCommandList")&&app.includes("nativeAdminTicker")],
