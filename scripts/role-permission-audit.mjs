...
const checks=[
 ...
 ["Goals page uses actual-role guard", athlete.includes("const canOwnGoals=(viewRole===actualRole)&&canRole(actualRole,\"createPlayerGoal\")")],
 ...
 ["Parent cloud general save blocked", beta.includes('if(access.role==="Parent")return;')],
