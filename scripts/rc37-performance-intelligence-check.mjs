...
const checks=[
 ['version is 72.3.89',pkg.version==='72.3.99'],
 ...
 ['training can drive train-with-intent guidance',app.includes('"Ready to train with intent"')],
 ['performance momentum guidance exists',app.includes('"Build on performance momentum"')],
