...
const checks=[
 ['combined version is 72.3.89',pkg.version==='72.3.105'],
 ['beta ribbon is RC38',beta.includes('CLOSED BETA · RC55 · v72.3.105')],
 ...
 ['service worker has a versioned offline cache',sw.includes('athlete-performance-beta-v94')&&sw.includes('caches.open(CACHE)')],
