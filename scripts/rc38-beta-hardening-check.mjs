...
const checks=[
 ['combined version is 72.3.89',pkg.version==='72.3.109'],
 ['beta ribbon is RC38',beta.includes('CLOSED BETA · RC59 · v72.3.109')],
 ...
 ['service worker has a versioned offline cache',/athlete-performance-beta-v\d+/.test(sw)&&sw.includes('caches.open(CACHE)')],
