...
check(pkg.version==="72.3.108","combined release version is Phase 72.3.108");
check(beta.includes("CLOSED BETA · RC58 · v72.3.108"),"RC47 closed-beta ribbon is present");
