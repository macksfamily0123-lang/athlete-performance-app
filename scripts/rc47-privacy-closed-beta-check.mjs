...
check(pkg.version==="72.3.116","combined release version is Phase 72.3.109");
check(beta.includes("CLOSED BETA · RC66 · v72.3.116"),"RC47 closed-beta ribbon is present");
...
check(app.includes("Install Elite Performance")&&app.includes("beforeinstallprompt"),"install guidance supports PWA-capable browsers");
