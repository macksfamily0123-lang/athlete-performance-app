...
check(pkg.version==="72.3.112","combined release version is Phase 72.3.109");
check(beta.includes("CLOSED BETA · RC62 · v72.3.112"),"RC47 closed-beta ribbon is present");
