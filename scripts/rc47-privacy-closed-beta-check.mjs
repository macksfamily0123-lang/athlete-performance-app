...
check(pkg.version==="72.3.106","combined release version is Phase 72.3.106");
check(beta.includes("CLOSED BETA · RC56 · v72.3.106"),"RC47 closed-beta ribbon is present");
