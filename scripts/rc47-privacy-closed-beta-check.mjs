...
check(pkg.version==="72.3.107","combined release version is Phase 72.3.107");
check(beta.includes("CLOSED BETA · RC57 · v72.3.107"),"RC47 closed-beta ribbon is present");
