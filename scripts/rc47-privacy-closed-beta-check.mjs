...
check(pkg.version==="72.3.115","combined release version is Phase 72.3.109");
check(beta.includes("CLOSED BETA · RC65 · v72.3.115"),"RC47 closed-beta ribbon is present");
