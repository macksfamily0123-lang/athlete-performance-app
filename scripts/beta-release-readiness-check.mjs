...
const checks=[
 ["Combined version is 72.3.74",pkg.version==="72.3.77"],
 ["RC24 ribbon",beta.includes("BETA · RC27 · v72.3.77")],
 ["Feedback version is 72.3.74",beta.includes('app_version:"72.3.77"')],
 ["Admin health version is RC24",athlete.includes('["App Version","72.3.77 RC27","good"]')],
