...
const checks=[
 ["Combined version is 72.3.74",pkg.version==="72.3.98"],
 ["RC24 ribbon",beta.includes("CLOSED BETA · RC48 · v72.3.98")],
 ["Feedback version is 72.3.74",beta.includes('app_version:"72.3.98"')],
 ["Admin health version is RC24",athlete.includes('["App Version","72.3.98 RC48","good"]')],
