...
const checks=[
 ["Combined version is 72.3.74",pkg.version==="72.3.115"],
 ["RC24 ribbon",beta.includes("CLOSED BETA · RC65 · v72.3.115")],
 ["Feedback version is 72.3.74",beta.includes('app_version:"72.3.115"')],
 ["Admin health version is RC24",athlete.includes('["App Version","72.3.115 RC65","good"]')],
