...
const checks=[
 ["Combined version is 72.3.74",pkg.version==="72.3.107"],
 ["RC24 ribbon",beta.includes("CLOSED BETA · RC57 · v72.3.107")],
 ["Feedback version is 72.3.74",beta.includes('app_version:"72.3.107"')],
 ["Admin health version is RC24",athlete.includes('["App Version","72.3.107 RC57","good"]')],
