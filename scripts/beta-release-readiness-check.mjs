...
const checks=[
 ["Combined version is 72.3.74",pkg.version==="72.3.90"],
 ["RC24 ribbon",beta.includes("BETA · RC40 · v72.3.90")],
 ["Feedback version is 72.3.74",beta.includes('app_version:"72.3.90"')],
 ["Admin health version is RC24",athlete.includes('["App Version","72.3.90 RC40","good"]')],
