...
check(pkg.version==="72.3.98","release version is Phase 72.3.98");
check(beta.includes("CLOSED BETA · RC48 · v72.3.98"),"RC48 release ribbon is present");
...
check(css.includes("Phase 72.3.98 RC48 — Readable Parent Player Creation"),"RC48 form layout styles are present");
...
console.log("RC48 Parent Player form checks passed.");
