...
const checks=[
 ...
 ["Feedback diagnostic context", beta.includes("Beta diagnostic context")&&beta.includes("Version: 72.3.107 RC57")],
 ...
 ["Feedback app version", beta.includes('app_version:"72.3.107"')],
