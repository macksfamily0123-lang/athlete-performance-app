...
const rc54=css.slice(css.indexOf("Phase 72.3.104 RC54 — Premium UX + Dashboard Correction"));

check(Number(pkg.version.split(".").at(-1))>=104,"release includes the Phase 72.3.104 baseline");
