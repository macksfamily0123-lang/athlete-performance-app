...
check(beta.includes("CLOSED BETA · RC56 · v72.3.106"),"RC55 release ribbon is present");
...
check(css.includes("Phase 72.3.106 RC56 — Home Connection Center"),"RC55 connection styles are installed");
