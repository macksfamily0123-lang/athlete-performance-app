...
check(beta.includes("CLOSED BETA · RC57 · v72.3.107"),"RC55 release ribbon is present");
...
check(css.includes("Phase 72.3.107 RC57 — Home Connection Center"),"RC55 connection styles are installed");
