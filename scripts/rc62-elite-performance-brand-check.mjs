...
check(css.includes("Phase 72.3.115 RC65 — Elite Performance Speed E refinement")&&css.includes(".elitePerformanceLogo img"),"responsive Elite Performance logo styles are installed");

console.log(`RC65 Elite Performance brand checks passed (${checks.length}/${checks.length}).`);
